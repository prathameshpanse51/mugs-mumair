    ...
    <>
      <main className="flex flex-col-reverse md:flex-row justify-between items-center px-4 md:px-36 py-20">
        <div className="flex flex-col gap-1 pt-20 md:pt-0">
          ...
          <p
            className={cn(
              "text-2xl md:text-3xl text-[#FD6F00]",
          ...
          <h1
            className={cn("text-6xl md:text-7xl pb-4", PoppinsBold.className)}
          >
            UI & UX <div className=" pl-14 md:pl-56">Designer</div>
          </h1>
          <p
            className={cn(
              "text-lg md:text-xl text-justify md:w-[550px] pb-6",
